...
operator_image="docker.io/solace/pubsubplus-eventbroker-operator:1.2.0"
watch_namespace="solace, solace-pubsubplus, sol-pubsubplus, pubsubplus"
op_tmp_yaml=".operator.yaml"
...
kind: ClusterRole
metadata:
  name: pubsubplus-eventbroker-operator-role
rules:
- apiGroups:
  - ""
  resources:
...
- apiGroups:
  - pubsubplus.solace.com
  resources:
  - pubsubpluseventbrokers/finalizers
  verbs:
  - update
- apiGroups:
  - pubsubplus.solace.com
  resources:
  - pubsubpluseventbrokers/status
  verbs:
  - get
  - patch
  - update
...
metadata:
  name: pubsubplus-eventbroker-operator-rolebinding
roleRef:
  apiGroup: rbac.authorization.k8s.io
  kind: ClusterRole
  name: pubsubplus-eventbroker-operator-role
